	...
	private boolean ejecutarOpciones(Scanner consola){
		...
		switch (opcion){
			...
			case 2 -> { //Buscar estudiante por id
				...
				var idEstudiante = Integer.parseInt(consola.nextLine()); //variable temporal
			...
			case 3 ->{ // Agregar estudiante
				...
				logger.info("Nombre: ");
				var nombre = consola.nextLine(); //guardamos el dato en una variable temporaria
				...
				var estudiante = new Estudiantes2022();  //creamos el objeto estudiante sin el id con constructor vacio
				estudiante.setNombre(nombre); // introducimos los datos
				estudiante.setApellido(apellido);
				estudiante.setTelefono(telefono);
				estudiante.setEmail(email);
				estudianteServicio.guardarEstudiante(estudiante); // guardamos el estudiante con todos sus datos
				logger.info("Estudiante agregado: "+ estudiante + nl); //mostramos ele studiante agregado
			}
